...
test("interactive menu offers step-ca and caddy-internal-ca in dependency order", () => {
  ...
  assert.deepEqual(
    ...
    ["provision-step-ca", "toggle-http-redirect", "upgrade-service", "remove-service", "destroy-service", "init", "exit"]
  );
  ...
  assert.deepEqual(
    ...
    ["provision-caddy-internal-ca", "toggle-http-redirect", "upgrade-service", "remove-service", "destroy-service", "init", "exit"]
  );
});
